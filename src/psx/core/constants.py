...
SECTOR_PEERS = {
    ...
    "Automobile Assembler": ["INDU", "PSMC", "HCAR", "MTL", "HUBC", "GHNI", "SAZEW", "MTL"],
    "Pharmaceuticals": ["SEARL", "GLAXO", "HINOON", "ABOT", "FEROZ"],
    "Technology & Communication": ["TRG", "SYS", "NETSOL"],
    "Insurance": ["JSGCL", "PKGI", "AICL", "EFU"],
    "Inv. Banks / Inv. Cos. / Securities Cos.": ["LSECL", "JSIL", "AKDHL", "FNEL"],
    "Food & Personal Care Products": ["NESTLE", "UNITY", "COLG", "FCEPL", "NATF"],
    "Textile Composite": ["NML", "NCL", "GATM", "ILP", "KOIL"],
    "Sugar & Allied Industries": ["ALNRS", "AGSML", "JDWS", "MLCF"],
    "Chemical": ["LOTCHEM", "ICI", "EPCL", "GCIL"],
